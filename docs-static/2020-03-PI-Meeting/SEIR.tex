...
\[ \frac{dS}{dt} = -\frac{R_t}{T_{\mathrm{inf}}} \cdot IS,
    \qquad \frac{dE}{dt} = \frac{R_t}{T_{\mathrm{inf}}} \cdot IS -
    T^{-1}_{\mathrm{inc}} E\]
  \[\frac{dI}{dt} = T^{-1}_{\mathrm{inc}}E -
        T^{-1}_{\mathrm{inf}} I,\qquad  \frac{dR}{dt} = T^{-1}_{\mathrm{inf}} I \]
